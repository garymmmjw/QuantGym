...
export function getModuleSearchDefs(t = (key) => key) {
  return [
    ...
    { module: "problems", label: t("problems"), detail: "Problem bank / 题库", fields: [t("problems"), "problems", "题目", "题库", "question bank", "problem bank", "概率题", "technical interview", "tech interview", "技术面试", "葵花宝典", "蓝宝书"] },
