...
export function createAccountAuthBundle(deps = {}) {
  ...
  const accountControllerBundle = createAccountControllerBundle({
    ...
    setResetPasswordCodeButtonBusy: authUiRuntime.setResetPasswordCodeButtonBusy,
    startRegisterCodeCooldown: authUiRuntime.startRegisterCodeCooldown,
    startResetPasswordCodeCooldown: authUiRuntime.startResetPasswordCodeCooldown,
    showAuthMessage,
    getVerificationErrorMessage,
    getAuthErrorMessage,
  ...
  return {
    ...
    resetPassword: accountControllerBundle.resetPassword,
    resetEmailAuthFlow: accountControllerBundle.resetEmailAuthFlow,
    startPasswordReset: accountControllerBundle.startPasswordReset,
    cancelPasswordReset: accountControllerBundle.cancelPasswordReset,
    renderGoogleClientInput: authUiRuntime.renderGoogleClientInput,
    ...
    sendPasswordResetCode: accountControllerBundle.sendPasswordResetCode,
