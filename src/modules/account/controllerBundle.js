...
export function createAccountControllerBundle(deps = {}) {
  ...
  const accountAuthController = createAccountAuthController({
    ...
    resetCloudPassword: authCloudClient.resetPassword,
    ...
    setResetPasswordCodeButtonBusy: deps.setResetPasswordCodeButtonBusy,
    startRegisterCodeCooldown: deps.startRegisterCodeCooldown,
    startResetPasswordCodeCooldown: deps.startResetPasswordCodeCooldown,
  ...
  return {
    ...
    startPasswordReset: accountAuthController.startPasswordReset,
    cancelPasswordReset: accountAuthController.cancelPasswordReset,
    sendRegisterVerificationCode: accountAuthController.sendRegisterVerificationCode,
    sendPasswordResetCode: accountAuthController.sendPasswordResetCode,
    registerLocal: accountAuthController.registerLocal,
    loginLocal: accountAuthController.loginLocal,
    resetPassword: accountAuthController.resetPassword,
