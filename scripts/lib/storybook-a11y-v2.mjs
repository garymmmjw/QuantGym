export const EXPECTED_STORY_IDS = Object.freeze([
  ...
  "patterns-dashboardtemplate--empty",
  "patterns-dashboardtemplate--error",
  "patterns-dashboardtemplate--loading",
  "patterns-dashboardtemplate--offline",
  "patterns-dashboardtemplate--permission-denied",
  "patterns-dashboardtemplate--ready",
  "patterns-draftstatus--conflict",
  "patterns-draftstatus--error",
  "patterns-draftstatus--offline",
  "patterns-draftstatus--reduced-motion",
  "patterns-draftstatus--saved",
  "patterns-draftstatus--saving",
  "patterns-emptystate--copy-only",
  "patterns-emptystate--empty",
  "patterns-emptystate--error",
  "patterns-filterbar--disabled",
  "patterns-filterbar--focus",
  "patterns-filterbar--ready",
  "patterns-listdetail--mobile-detail",
  "patterns-listdetail--permission-denied",
  "patterns-listdetail--split",
  "patterns-metric--loading",
  "patterns-metric--ready",
  "patterns-metric--reward",
  "patterns-pagination--boundary",
  "patterns-pagination--loading-disabled",
  "patterns-pagination--ready",
  "patterns-quantyimage--decorative",
  "patterns-quantyimage--ready",
  "patterns-resultsummary--completion",
  "patterns-resultsummary--error",
  "patterns-resultsummary--reduced-motion",
  "patterns-resultsummary--reward",
  "patterns-workflowboard--disabled",
  "patterns-workflowboard--empty",
  "patterns-workflowboard--ready",
