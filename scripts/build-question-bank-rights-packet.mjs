...
function renderSourceMarkdown(source) {
  ...
  return [
    ...
    "",
    "If approved, please provide the grantor name/role, any license terms, and an evidence URL or written approval record that can be stored without secrets or query tokens.",
    "",
    "## Manifest Draft",
    "",
