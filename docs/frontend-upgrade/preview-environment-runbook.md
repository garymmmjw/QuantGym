...
Use the exact LLM Dashboard Service Address host quantgym-v2-preview-llm and its assigned port.
Form the internal origin as `http://<service-address>`; a private service must not
